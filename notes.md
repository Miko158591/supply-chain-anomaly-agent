...
> **最终口径提示**：本文件是按时间追加的开发记录，早期章节保留当时实验口径（如 10/89 条评测集、z=2.5、F1=61.5%/66.7% 等）。当前项目最终口径以 README、`docs/PROJECT_CONTEXT.md` 和 `eval/README.md` 为准：评测集 106 条，z=2.0，Precision=64.3%，Recall=83.3%，F1=72.6%，归因整体质量约 3.4/5。
