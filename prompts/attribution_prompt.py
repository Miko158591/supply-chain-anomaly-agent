...
**evidence 质量反例（绝对禁止）**：
❌ "SOP-002指出折扣叠加是亏损的两大主因" — 引用 SOP 不引用数据
❌ "该订单属于严重亏损" — 笼统描述，无数值
✅ "实际亏损 -$277.09，超出正常范围上界 $283 约 16%，且品类近7天均值仅 $8.50 远低于全局 $26.39" — 含具体数字+对比基准
✅ "延迟 4 天，品类均值 0.68 天（全局 0.46 天），偏离品类均值 488%" — 数值+对比+偏离度
